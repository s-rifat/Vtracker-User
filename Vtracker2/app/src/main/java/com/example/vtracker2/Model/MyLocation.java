...
public class MyLocation {
    ...
    private long time,elapseRealTimeNanos;
    ...
    public long getElapseRealTimeNanos() {
        return elapseRealTimeNanos;
    }

    public void setElapseRealTimeNanos(long elapseRealTimeNanos) {
        this.elapseRealTimeNanos = elapseRealTimeNanos;
    }
